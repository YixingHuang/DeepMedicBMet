...
class Trainer(object):
    ...
    def create_optimizer(   self,
        ...
        if sgd0orAdam1orRmsProp2 == 0:
            ...
            self._optimizer = optimizers_dm.AdamOptimizerSI( params_to_opt,
                                                           self._curr_lr,
                                                           b1ParamForAdam,
                                                           b2ParamForAdam,
                                                           epsilonForAdam,
        ...
        elif sgd0orAdam1orRmsProp2 == 4:
            self._optimizer = optimizers_dm.RmsPropOptimizerSI(  params_to_opt,
                                                              self._curr_lr,
                                                              self._curr_mom,
                                                              momentumTypeNONNormalized0orNormalized1,
                                                              classicMomentum0OrNesterov1,
    ...
    def get_param_updates_wrt_task(self):
        # Excludes BN rolling average updates.
        updates = self._optimizer.get_update_ops_task( ) # A list of assign ops. For SI optimizer's params.
        return updates
