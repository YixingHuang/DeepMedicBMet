...
#### VSS loss
The VSS loss is located at [here]([./DeepMedicBMet/deepmedic/neuralnet/cost_functions.py](https://github.com/YixingHuang/DeepMedicBMet/blob/main/deepmedic/neuralnet/cost_functions.py)).
